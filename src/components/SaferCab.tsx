...
const cabProviders = [
  ...
  },
  {
    ...
    info: 'Meero Cab provides a 24/7 safe and secure ride with professional drivers.',
    ...
    <section className="py-16 sm:py-20 lg:py-28 px-4 sm:px-8 lg:px-10 bg-[#FDF8F3]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-lg text-gray-800 mb-6 max-w-3xl mx-auto">
            From eco-friendly electric rides to luxury options, we've got something for every traveler. Explore, select, and hit the road in no time!
          </p>
        </div>
          ...
          {cabProviders.map((provider) => (
            <div
              ...
              className="group relative bg-white rounded-2xl p-8 transition-all duration-300
                        ...
                        border border-gray-200 active:shadow-inner active:bg-gray-50"
            >
              <div className="flex flex-col items-center text-center">
                {/* Logo Container */}
                <div
                  className={`${provider.bgColor} ${provider.hoverColor} 
                ...
                <button
                  className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white py-2 px-6 rounded-full
                            transition-all duration-300 hover:bg-gradient-to-r hover:from-blue-600 hover:to-indigo-700
                            active:bg-gradient-to-r active:from-blue-700 active:to-indigo-800"
                >
                  Ready to Ride
                </button>
              </div>
              ...
              <div className="absolute inset-0 rounded-2xl transition-colors duration-300
                            group-hover:bg-black/[0.1] group-active:bg-black/[0.15]" />
            </div>
          ))}
        </div>
      </div>

      {/* Extra Long Section to Make the Page Feel Full */}
      <div className="mt-20 text-center">
        <h3 className="text-3xl font-semibold text-gray-800 mb-6">Experience the Future of Rides!</h3>
        <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
          Discover innovative features that make your journey smoother, smarter, and more enjoyable. From AI-powered route optimizations to real-time tracking, we are constantly innovating for your convenience.
        </p>
        <div className="flex justify-center">
          <div className="bg-gradient-to-r from-indigo-600 to-purple-700 p-8 rounded-lg shadow-lg w-1/2">
            <p className="text-xl text-white">Coming Soon: AI-based trip planning, smart fare calculators, and enhanced driver communication features!</p>
          </div>
        </div>
      </div>
    </section>
